...
def generate_llm_response(messages, model="gpt-4o-mini", temperature=0.3, top_p=1.0, max_tokens=256, n=1, json_output=False):
    if json_output == True:
    ...
    system_instructions = {"role" : "system", "content" : 
                           """
                            You are an experienced supervisor, and the user is your subordinate in the work setting.
                            You are having a conversation with your subordinate about flexible work arrangements.
                            Your subordinate is keen on adopting one or more forms of flexible work arrangements.
                            ...
                            best interest at heart and will want to support them as much as possible, while keeping in mind 
                            ...
                            on their request and politely signalling that we could try out your proposal
